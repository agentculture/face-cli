...
Every failure inside face-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`face_cli.cli._output`,
...
# Exit-code policy. Documented in ``face-cli learn`` output.
# 0      = success
